      ...
      <div class="container-fluid">
        <nav class="navbar navbar-expand-lg custom_nav-container ">
          <a class="navbar-brand" href="./home.php">
            <i><img height="30px" src="assets/img/marwari.jpeg"></i>
            <span>
            Book Haven
            </span>
          </a>
          ...
          <div class="carousel-item active">
            <div class="container-fluid ">
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="img-box">
                    <img style="height: 450px; width: 500px;" src="./assets/images/s4.png" alt="">
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="carousel-item ">
            <div class="container-fluid ">
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="img-box">
                  <img style="height: 450px; width: 500px;" src="./assets/images/s3.png" alt="">
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="carousel-item ">
            <div class="container-fluid ">
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="img-box">
                  <img style="height: 450px; width: 500px;" src="./assets/images/s2.png" alt="">
                  </div>
                </div>
              </div>
            </div>
  ...
  <section class="contact_section">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="img-box">
            <img style="height: auto; width:auto"  src="./assets/images/about.png" alt="">
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="carousel-wrap ">
        <div class="owl-carousel client_owl-carousel">
          <div class="item">
            <div class="box">
              <div class="img-box">
                <img src="./assets/images/princpal.png" alt="">
              </div>
              <div class="detail-box">
