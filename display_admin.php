...
else
{
    ...
    $id_admin=$_GET['id'];
    //find email and name
    $sqlx="SELECT * FROM admin_login WHERE id = '$id_admin'";
    $queryx=mysqli_query($con,$sqlx);//query fire
    $rs1x = mysqli_fetch_array($queryx);

      $name_admin=$rs1x['name'];//name of student
      $emp_admin=$rs1x['emp_id'];//class roll of student
      $user_admin=$rs1x['username'];//username of student
      $department = $rs1x["department"];//department
      $email_admin=$rs1x['email'];//email of student
        ...
        <div class="col-xl-4">
          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              ...
              <img src="./assets/images/profile.png" alt="Profile" class="rounded-circle">
              <h2><a href="#"><?php echo $name_admin;?>      <i style="height: 22px; width: 22px;" class="bi bi-patch-check-fill"></i></a></h2>
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php echo $name_admin;?></div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php echo $emp_admin;?></div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Username</div>
                    <div class="col-lg-9 col-md-8"><?php echo $user_admin;?></div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php echo $email_admin;?></div>
                  </div>  
...
if(isset($_POST['update']))
{
  ...
  reg_id='$_POST[reg]', exam_id='$_POST[exam]', class_roll='$_POST[class]',
                ...
                <div class="tab-pane fade pt-3" id="profile-change-password">
                  ...
                  <form method="post" action="email1.php">
                    ...
                    <div class="text-center">
                      ...
                      <button id='change' name="change"  class="btn btn-primary" type="submit">Change Password</button>
                    </div>
