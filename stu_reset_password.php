		...
		<div class="screen__content">
			...
			<form class="login" method="post">
				<div class="login__field">
					...
					<input id="p1" name="p1" type="password" class="login__input" placeholder="New Password" required/>
				</div>
				<div class="login__field">
...
if(isset($_POST['reset']))
{
    ...
    if($p1==$p2)//if password is true
    {
        ...
        $res=mysqli_query($con,"UPDATE `student_details` SET password = '$p1', otp = NULL WHERE reg_id='$emp'");		
    ...
    else
    {
		...
		echo "<script>                
			swal({
                ...
                text:  'Password Not Match, please try again or contact admin',
				}).then(function() {
					window.location = 'stu_login.php';
				});                        
			</script>";//got to login
